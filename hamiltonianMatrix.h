...
In this file there are routines corresponding to different implementations
to act with the hamiltonian in a vector of complex numbers that  represent
a many body state in the Fock state basis.
...
/** Apply the many-body hamiltonian in a state expressed in
  * number-occupation basis with coefficients defined by C.
  *
  * SECOND IMPLEMENTATION - Uses mappings for 1 jump and double jump
...
/** Apply the many-body hamiltonian in a state expressed in
  * number-occupation basis with coefficients defined by C.
  *
  * THIRD IMPLEMENTATION - Uses all mappings **/
...
void applyHconf_omp (int N, int M, Iarray Map, Iarray MapOT, Iarray MapTT,
     Iarray strideOT, Iarray strideTT, Iarray IF, Carray C, Cmatrix Ho,
     Carray Hint, Carray out)
{
...
/** Apply the many-body hamiltonian in a state expressed in
  * number-occupation basis with coefficients defined by C.
  *
  * FOURTH IMPLEMENTATION - parallelized version of the third **/
